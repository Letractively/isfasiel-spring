...
<body>
<form method="post" action="<c:url value="/app/real/create.do"/>" onsubmit="return doSubmit();">
...
<!--	body <input type="text" name="body" value="${result.body}"/><br/>-->
	...
	<input type="text" name="posX" value="0.111"/><br/>
	<input type="text" name="posY" value="0.222"/><br/>
	<input type="text" name="suburb" value="Brisbane"/><br/>
	<input type="text" name="pathId" value="1"/><br/>
