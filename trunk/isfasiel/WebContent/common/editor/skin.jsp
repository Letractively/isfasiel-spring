...
<div id="smart_editor" class="smart_editor">
	<div id="smart_content"> <a href="#husky_iframe" class="skip">&raquo; 편집 도구모음 건너뛰기</a>
		...
		<div class="input_area husky_seditor_editing_area_container">
			<iframe src="./se_blank.jsp" id="husky_iframe" name="husky_iframe" class="input_wysiwyg" frameborder="0" scrolling="yes" title="리치 에디터 - 편집기에서 빠져 나오시려면 ESC키를 누르세요" style="display:block;"></iframe>
